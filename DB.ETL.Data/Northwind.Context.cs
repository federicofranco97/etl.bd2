...
namespace DB.ETL.Data
{
    ...
    public partial class NorhwindDWEntities : DbContext
    {
        public NorhwindDWEntities()
            : base("name=NorhwindDWEntities")
        {
        }
        ...
        public virtual DbSet<Fact_Orden> Fact_Orden { get; set; }
